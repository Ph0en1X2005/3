...
В ходе выполнения данной работы я проанализировал оружие в игре Save RTF. Также я предложил свои варианты вооружения и сбалансировал их в таблице, а также построил модели параметров сбалансированного оружия с помощью программ на python.
